 ...
 *
 */
public class RightRightRight extends CommandGroup {

    public RightRightRight(int startingPosition) {
		...
		case 1:
			...
			addSequential(new DriveStraightWithGyro(-.3,RobotMap.distnceToSwitch,-90));
