 ...
 *
 */
public class LeftLeftLeft extends CommandGroup {

    public LeftLeftLeft(int startingPosition) {
    	switch (startingPosition) {
		case 1:
			//Right
			addSequential(new DriveStraightWithGyro(-.6,RobotMap.AutoLine));
		...
		case 3:
			...
			addSequential(new CubeOuttakeAuto(.5));
			addSequential(new CascadeDownByTime(RobotMap.SwitchHeight)); 
		    addSequential(new DriveStraightWithGyro(.3,RobotMap.DistnceFromSwitch,0));
			break;
		}
        // Add Commands here:
