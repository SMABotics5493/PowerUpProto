...
public class OI {
	...
	JoystickButton candyForward = new JoystickButton(driveJoystick, RobotMap.JOYBTN_Y);
	JoystickButton candyReverse = new JoystickButton(driveJoystick, RobotMap.JOYBTN_A);
	...
	JoystickButton shiftLowSolenoid = new JoystickButton(driveJoystick, RobotMap.JOYBTN_X);
	JoystickButton shiftHighSolenoid = new JoystickButton(driveJoystick, RobotMap.JOYBTN_B);
	...
	public OI() {
		...
		candyForward.whenPressed(new EndForward());
		candyReverse.whenPressed(new EndReverse());
		...
		shiftLowSolenoid.whenPressed(new TransmissionForward());
		shiftHighSolenoid.whenPressed(new TransmissionReverse());
